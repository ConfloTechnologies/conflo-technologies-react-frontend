...
const NewRequestForInformationPage: React.FC = () => {
    const contacts = [
        ...
        <div className="flex flex-col h-[85vh] p-4">
            ...
            <div className="sticky top-0 z-10 bg-white">
                ...
                <div className="border-b border-gray-300 text-xl font-bold pt-2 pb-2 pl-2 bg-white">
                    <h2>New Request For Information</h2>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-6 gap-4 ">
                        <div className="col-span-6 grid grid-cols-6 gap-4">
                            ...
                            <div className="col-span-full md:col-span-3">
                                <label className="block text-sm font-medium text-gray-900">RFI Title</label>
                                <input
                                    type="text"
                                    name="meetingTitle"
                            ...
                            <div className="hidden md:grid md:col-span-3">{/* placeholder */}</div>
                            ...
                            <div className="col-span-full md:col-span-2">
                                <label className="block text-sm font-medium text-gray-900">RFI Manager</label>
                                <input
                                    type="date"
                                    name="meetingDate"
                                    className="mt-1 block w-full pl-3 pr-10 py-1 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
                            ...
                            <div className="col-span-full md:col-span-2">
                                <label className="block text-sm font-medium text-gray-900">Drawing Number</label>
                                <input
                                    type="text"
                                    name="timeZone"
                                    className="mt-1 block w-full pl-3 pr-10 py-1 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
                            ...
                            <div className="col-span-full md:col-span-2">
                                <label className="block text-sm font-medium text-gray-900">Schedule Impact</label>
                                <input
                                    type="text"
                                    name="timeZone"
                                    className="mt-1 block w-full pl-3 pr-10 py-1 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
                            ...
                            <div className="col-span-full md:col-span-2">
                                <label className="block text-sm font-medium text-gray-900">Cost Impact</label>
                                <input
                                    type="text"
                                    name="timeZone"
                                    className="mt-1 block w-full pl-3 pr-10 py-1 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 rounded-md"
...
export default NewRequestForInformationPage;
