...
const tabs = [
    { name: "All RFI's", href: '#', key: 'all' },
    { name: 'RFI Groups', href: '#', key: 'groups' },
  ]
...
export default function Meetings() {
  ...
  return (
    <>
      <PageHeader
        pageTitle={"RFI's"}
        pageDescription={"A list of all RFI's associated with this project."}
        ...
        trainingTitle={"Request For Information Training"}
      />
        ...
        />
          ...
          <div className="flex items-center justify-end space-x-2 sm:space-x-4 max-w-full py-2 bg-white ">
            ...
            >
              ...
              <p className="hidden sm:block text-md font-semibold mx-1">RFI</p>
            </button>
