...
const companiesWithContacts = {
  ...
  "Beta LLC": {
    ...
    type: "external",
    contacts: [
      { firstName: "Oliver", lastName: "Paula", phone: "123-456-7807", email: "oliver.paula@example.com", role: "external", title: "Plumber", tradeCode: "Plumbing-003" },
...
//     type: "external",
//     contacts: [
//       { firstName: "Edward", lastName: "Fiona", phone: "123-456-7802", email: "edward.fiona@example.com", role: "external", title: "Carpenter", tradeCode: "Carpentry" },
//       { firstName: "George", lastName: "Hannah", phone: "123-456-7803", email: "george.hannah@example.com", role: "external", title: "Electrician", tradeCode: "Electrical" }
//     ]
//   },
//   "Beta LLC": {
//     legalName: "Beta Limited Liability Company",
...
//     type: "external",
//     contacts: [
//       { firstName: "Oliver", lastName: "Paula", phone: "123-456-7807", email: "oliver.paula@example.com", role: "external", title: "Plumber", tradeCode: "Plumbing" },
//       { firstName: "Quincy", lastName: "Rachel", phone: "123-456-7808", email: "quincy.rachel@example.com", role: "external", title: "Civil Engineer", tradeCode: "Civil Engineering" }
//     ]
//   },
//   "Gamma Inc": {
//     legalName: "Gamma Incorporated",
...
//     type: "external",
//     contacts: [
//       { firstName: "Wanda", lastName: "Xavier", phone: "123-456-7811", email: "wanda.xavier@example.com", role: "external", title: "Carpenter", tradeCode: "Carpentry" },
//       { firstName: "Adam", lastName: "Bellamy", phone: "123-456-7813", email: "adam.bellamy@example.com", role: "external", title: "Plumber", tradeCode: "Plumbing" }
//     ]
//   },
//   "Delta Ltd": {
//     legalName: "Delta Limited",
...
//     type: "external",
//     contacts: [
//       { firstName: "Ian", lastName: "Jennings", phone: "123-456-7817", email: "ian.jennings@example.com", role: "external", title: "Carpenter", tradeCode: "Carpentry" },
//       { firstName: "Kyle", lastName: "Laurent", phone: "123-456-7818", email: "kyle.laurent@example.com", role: "external", title: "Electrician", tradeCode: "Electrical" }
//     ]
//   },
//   "Epsilon GmbH": {
//     legalName: "Epsilon GmbH",
...
//     type: "external",
//     contacts: [
//       { firstName: "Quinn", lastName: "Reed", phone: "123-456-7821", email: "quinn.reed@example.com", role: "external", title: "HVAC Specialist", tradeCode: "HVAC" },
//       { firstName: "Uma", lastName: "Vargas", phone: "123-456-7823", email: "uma.vargas@example.com", role: "external", title: "Carpenter", tradeCode: "Carpentry" }
//     ]
//   },
//   "Cooper Building": {
//     legalName: "Cooper Building Inc.",
...
//   const [searchQuery, setSearchQuery] = useState('');
//   const [isNewContactModalOpen, setIsNewContactModalOpen] = useState(false);
//   const [expandedCompany, setExpandedCompany] = useState(Object.keys(companiesWithContacts)[0]); // Default to the first company
...
//   const handleAccordionToggle = (companyName) => {
...
//                             </div>
//                           </td>
//                           <td colSpan={3} className="px-4 py-3 text-sm font-medium text-gray-800">
//                             {/* Empty cell for alignment */}
//                           </td>
//                           <td className="pr-4 py-3 text-sm text-right">
//                             <button
//                               type="button"
//                               onClick={() => handleAccordionToggle(user.companyName)}
//                               className="text-gray-600 hover:text-gray-900 focus:outline-none"
//                             >
//                               {expandedCompany === user.companyName ? <ChevronUpIcon className="h-5 w-5" /> : <ChevronDownIcon className="h-5 w-5" />}
//                             </button>
//                           </td>
//                         </tr>
//                         {expandedCompany === user.companyName && user.contacts.map((contact, contactIdx) => (
