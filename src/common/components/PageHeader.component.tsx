...
const PageHeader: React.FC<PageHeaderProps> = ({ pageTitle, pageDescription, trainingVideoSrc, trainingTitle }) => {
    return (
        <>
            <div className='grid grid-cols-2 border pl-2 pr-2 py-2 rounded-lg'>
