...
export default function Pagination({ itemsPerPage, totalItems, currentPage, onPageChange }) {
  ...
  return (
    ...
    <nav aria-label="Pagination" className="fixed ml-0 lg:ml-64 mt-10 inset-x-0 bottom-0 flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
